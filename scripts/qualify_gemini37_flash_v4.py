...
"""One-shot qualification wrapper for Gemini 3.7 Flash under active Event Understanding V4.
...
from insight_desk.providers.gemini37 import GEMINI_37_FLASH, Gemini37FlashStructuredClient
from scripts import qualify_event_understanding_provider_v4 as canonical


CANDIDATE_PROVIDER = "gemini37_flash"
...
def registered_candidate_provider() -> Iterator[None]:
    ...
    def provider_client(provider: str):
        if provider == CANDIDATE_PROVIDER:
            client = Gemini37FlashStructuredClient.from_env()
            return client, GEMINI_37_FLASH
