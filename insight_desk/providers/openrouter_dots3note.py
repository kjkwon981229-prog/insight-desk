...
"""Qualification-only OpenRouter Dots3-Note structured client for Event Understanding V5."""
...
OPENROUTER_DOTS3_NOTE_FREE = "dots-studio/dots-3-note-preview:free"


@dataclass(slots=True)
class OpenRouterDots3NoteStructuredClient:
    api_key: str
    model_id: str = OPENROUTER_DOTS3_NOTE_FREE
    transport: JsonHttpTransport | None = None

    def __post_init__(self) -> None:
        if self.model_id != OPENROUTER_DOTS3_NOTE_FREE:
            raise ValueError(
                "OpenRouter V5 candidate is frozen to dots-studio/dots-3-note-preview:free"
            )
