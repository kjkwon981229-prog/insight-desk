...
"""Qualification-only Mistral Small 4 client for Event Understanding V5.

This exact provider/model route is isolated from frozen historical Mistral routes. It is
intentionally not exported from ``insight_desk.providers`` and is not wired into production.
"""
...
class MistralSmall4StructuredClient:
    api_key: str
    model_id: str = MISTRAL_SMALL_4
    transport: JsonHttpTransport | None = None

    def __post_init__(self) -> None:
        if self.model_id != MISTRAL_SMALL_4:
            raise ValueError("Mistral Event Understanding V5 candidate is frozen to mistral-small-2603")
