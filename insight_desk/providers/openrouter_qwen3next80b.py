...
"""Qualification-only OpenRouter Qwen3-Next 80B structured client for Event Understanding V5."""
...
OPENROUTER_QWEN3_NEXT_80B_FREE = "qwen/qwen3-next-80b-a3b-instruct:free"


@dataclass(slots=True)
class OpenRouterQwen3Next80BStructuredClient:
    api_key: str
    model_id: str = OPENROUTER_QWEN3_NEXT_80B_FREE
    transport: JsonHttpTransport | None = None

    def __post_init__(self) -> None:
        if self.model_id != OPENROUTER_QWEN3_NEXT_80B_FREE:
            raise ValueError(
                "OpenRouter V5 candidate is frozen to qwen/qwen3-next-80b-a3b-instruct:free"
            )
