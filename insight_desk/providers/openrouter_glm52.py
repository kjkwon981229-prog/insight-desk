...
"""Qualification-only OpenRouter GLM 5.2 structured client for Event Understanding.
...
OPENROUTER_GLM_52_FREE = "z-ai/glm-5.2:free"


@dataclass(slots=True)
class OpenRouterGlm52StructuredClient:
    api_key: str
    model_id: str = OPENROUTER_GLM_52_FREE
    transport: JsonHttpTransport | None = None

    def __post_init__(self) -> None:
        if self.model_id != OPENROUTER_GLM_52_FREE:
            raise ValueError(
                "OpenRouter GLM 5.2 Event Understanding candidate is frozen to "
                "z-ai/glm-5.2:free"
            )
