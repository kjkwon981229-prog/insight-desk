...
"""Qualification-only Cerebras GLM 4.7 structured client for Event Understanding.
...
CEREBRAS_GLM_47 = "zai-glm-4.7"
CEREBRAS_CHAT_URL = "https://api.cerebras.ai/v1/chat/completions"


@dataclass(slots=True)
class CerebrasGlm47StructuredClient:
    api_key: str
    model_id: str = CEREBRAS_GLM_47
    transport: JsonHttpTransport | None = None

    def __post_init__(self) -> None:
        if self.model_id != CEREBRAS_GLM_47:
            raise ValueError("Cerebras Event Understanding candidate is frozen to zai-glm-4.7")
