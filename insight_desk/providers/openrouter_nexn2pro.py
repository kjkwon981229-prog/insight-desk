...
"""Qualification-only OpenRouter Nex-N2-Pro structured client for Event Understanding V5."""
...
OPENROUTER_NEX_N2_PRO_FREE = "nex-agi/nex-n2-pro:free"


@dataclass(slots=True)
class OpenRouterNexN2ProStructuredClient:
    api_key: str
    model_id: str = OPENROUTER_NEX_N2_PRO_FREE
    transport: JsonHttpTransport | None = None

    def __post_init__(self) -> None:
        if self.model_id != OPENROUTER_NEX_N2_PRO_FREE:
            raise ValueError("OpenRouter V5 candidate is frozen to nex-agi/nex-n2-pro:free")
