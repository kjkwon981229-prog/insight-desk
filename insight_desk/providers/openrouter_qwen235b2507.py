...
"""Qualification-only OpenRouter Qwen3 235B A22B Instruct 2507 client.

This client is not exported from ``insight_desk.providers`` and is not wired into production.
The exact free model slug is frozen so qualification cannot silently move to the paid route,
a moving alias, or random model routing.
"""
...
OPENROUTER_QWEN3_235B_2507_FREE = "qwen/qwen3-235b-a22b-2507:free"


@dataclass(slots=True)
class OpenRouterQwen235B2507StructuredClient:
    api_key: str
    model_id: str = OPENROUTER_QWEN3_235B_2507_FREE
    transport: JsonHttpTransport | None = None

    def __post_init__(self) -> None:
        if self.model_id != OPENROUTER_QWEN3_235B_2507_FREE:
            raise ValueError(
                "OpenRouter Qwen3 235B 2507 Event Understanding candidate is frozen to "
