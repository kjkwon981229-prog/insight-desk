...
"""Qualification-only Mistral structured client for Event Understanding.
...
class MistralStructuredClient:
    api_key: str
    model_id: str = MISTRAL_LARGE_3
    transport: JsonHttpTransport | None = None

    def __post_init__(self) -> None:
        if self.model_id != MISTRAL_LARGE_3:
            raise ValueError("Mistral Event Understanding candidate is frozen to mistral-large-2512")
