...
from scripts import qualify_gemini37_flash_v4 as lane
...
class Gemini37FlashV4QualificationTests(unittest.TestCase):
    def test_candidate_is_exact_new_v4_model_and_production_owner_is_unchanged(self) -> None:
        self.assertEqual(GEMINI_37_FLASH, "gemini-3.7-flash")
        self.assertEqual(GEMINI_FLASH_LITE, "gemini-3.1-flash-lite")
        self.assertEqual(lane.CANDIDATE_PROVIDER, "gemini37_flash")
        ...
        with self.assertRaisesRegex(ValueError, "frozen"):
            Gemini37FlashStructuredClient(api_key="test", model_id=GEMINI_FLASH_LITE)
    ...
    def test_candidate_registration_is_scoped_to_v4_runner_only(self) -> None:
        ...
        with patch.dict(os.environ, {}, clear=True):
            with lane.registered_candidate_provider():
                ...
                self.assertEqual(v4._provider_model(lane.CANDIDATE_PROVIDER), GEMINI_37_FLASH)
    ...
    def test_missing_credential_reuses_active_v4_not_configured_contract(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertEqual(report["model"], GEMINI_37_FLASH)
