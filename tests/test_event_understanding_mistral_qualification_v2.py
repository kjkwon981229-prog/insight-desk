...
class EventUnderstandingMistralQualificationHarnessTests(unittest.TestCase):
    def test_mistral_candidate_is_registered_without_changing_frozen_fixture(self) -> None:
        ...
        self.assertEqual(qualification.DEFAULT_QUALIFICATION.name, "event_understanding_qualification_v1.json")
